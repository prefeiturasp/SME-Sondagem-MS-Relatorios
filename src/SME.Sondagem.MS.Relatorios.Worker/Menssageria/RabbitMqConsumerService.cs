...
public class RabbitMqConsumerService : BackgroundService
{
    ...
    private void RegistrarUseCases()
    {
        ...
        //_comandos.Add(RotasRabbit.RelatorioSondagemConsolidadoPorBimestre, new ComandoRabbit("Relatorio Sondagem Consolidado Por Bimestre", typeof(IRelatorioSondagemConsolidadoBimestreUseCase)));
